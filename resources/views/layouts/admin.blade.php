...
<head>
    ...
    <link href="{{ asset('cssvendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet" />
    <!-- Select2 CSS -->
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="#">
            <span class="navbar-brand-full"><img class="w_104" src="{{ asset('css/img/lg.png') }}" alt="">
